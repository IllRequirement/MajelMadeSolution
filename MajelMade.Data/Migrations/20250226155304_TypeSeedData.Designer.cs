...
namespace majelmade.data.Migrations
{
    ...
    [Migration("20250226155304_TypeSeedData")]
    partial class TypeSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MajelMade.Domain.Entities.EquipmentLogType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EquipmentLogTypeID = 1,
                            LogTypeName = "Maintenance"
                        },
                        new
                        {
                        ...
                        new
                        {
                            EquipmentLogTypeID = 3,
                            LogTypeName = "Inspection"
                        },
                        new
                        {
                            EquipmentLogTypeID = 4,
                            LogTypeName = "Calibration"
                        },
                        new
                        {
                            EquipmentLogTypeID = 5,
                            LogTypeName = "Upgrade"
                        });
                });
            ...
            modelBuilder.Entity("MajelMade.Domain.Entities.EquipmentStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EquipmentStatusID = 4,
                            StatusName = "Maintenance Required"
                        },
                        new
                        {
                            EquipmentStatusID = 5,
            ...
            modelBuilder.Entity("MajelMade.Domain.Entities.InventoryCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryName = "Meat",
                            Description = "Animal meat products"
                        },
                        new
                        {
                            InventoryCategoryID = 2,
                            CategoryName = "Dairy",
                            Description = "Milk, cheese, and related products"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MajelMade.Domain.Entities.InventoryTransactionType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TransactionTypeName = "Add"
                        },
                        new
                        {
                            InventoryTransactionTypeID = 2,
                            TransactionTypeName = "Subtract"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MajelMade.Domain.Entities.ModificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ModificationTypeID = 1,
                            ModificationName = "Extra Sauce"
                        },
                        new
                        {
                            ModificationTypeID = 2,
                            ModificationName = "No Salt"
                        },
                        new
                        {
                            ModificationTypeID = 3,
                            ModificationName = "Gluten-Free"
                        },
                        new
                        {
                            ModificationTypeID = 4,
                            ModificationName = "Extra Cheese"
                        },
                        new
                        {
                            ModificationTypeID = 5,
                            ModificationName = "Spicy"
                        });
                });
            ...
            modelBuilder.Entity("MajelMade.Domain.Entities.ShippingMethodType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ShippingMethodTypeID = 3,
                            MethodName = "Express"
                        },
                        new
                        {
                            ShippingMethodTypeID = 4,
                            MethodName = "Standard"
                        },
                        new
                        {
                            ShippingMethodTypeID = 5,
